...
<Dialog.Root>
	<Dialog.Trigger
		class="fixed top-4 left-4 z-50 rounded-full bg-dark text-background shadow-mini hover:bg-dark/95 focus-visible:ring-foreground focus-visible:ring-offset-background focus-visible:outline-hidden inline-flex h-12 w-12 items-center justify-center transition-colors focus-visible:ring-2 focus-visible:ring-offset-2 active:scale-[0.98]"
		onclick={(e) => {
			// Handle click
		}}
		onkeydown={(e) => {
