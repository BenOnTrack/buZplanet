...
>
	...
	<FillLayer
		...
		sourceLayer={'landuse'}
		beforeLayerType="symbol"
		filter={['all', ['==', 'class', 'transportation'], ['==', 'subclass', 'rail']]}
		paint={{
	...
	<FillLayer
		...
		sourceLayer={'landuse'}
		beforeLayerType="symbol"
		filter={['all', ['==', 'class', 'transportation'], ['==', 'category', 'car_parking']]}
		paint={{
			'fill-color': 'red',
	...
	<FillLayer
		...
		sourceLayer={'landuse'}
		beforeLayerType="symbol"
		filter={['all', ['==', 'class', 'leisure'], ['==', 'category', 'sports_centre']]}
		paint={{
			'fill-color': '#c7d4c9'
		}}
	></FillLayer>
	...
	<FillLayer
		...
		sourceLayer={'landuse'}
		beforeLayerType="symbol"
		filter={['all', ['==', 'class', 'leisure'], ['==', 'category', 'playground']]}
		paint={{
			'fill-color': '#c7d4c9'
		}}
	></FillLayer>
