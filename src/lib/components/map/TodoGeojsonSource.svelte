...
<script lang="ts">
	...
	interface Props {
		todoFeaturesGeoJSON: any;
	}
	let { todoFeaturesGeoJSON }: Props = $props();
...
<GeoJSON id="todoSource" data={todoFeaturesGeoJSON} cluster={{ maxZoom: 12, radius: 50 }}>
	<CircleLayer
		id="todoClusterCircles"
